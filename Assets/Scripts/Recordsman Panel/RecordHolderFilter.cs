...
public class RecordHolderFilter : MonoBehaviour
{
    [SerializeField] 
    ...
    [SerializeField] 
    private RecordHolderScrollView recordScrollView;
    ...
    private void OnEnable()
    {
        ...
        recordScrollView.ResetAllRecords();
        SetButtonSize();
        SetButtonSprite();
        ButtonClickAction();
    }
    ...
    private void ButtonClickAction()
    {
        if (soccerButton != null)
        {
            ...
            soccerButton.onClick.AddListener(() =>
            {
                ...
                SetButtonSize();
                recordScrollView.ResetAllRecords();
                recordScrollView.SpawnPrefabs(selectedCategory);
            });
        }
