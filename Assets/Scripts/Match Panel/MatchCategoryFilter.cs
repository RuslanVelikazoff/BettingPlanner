...
public class MatchCategoryFilter : MonoBehaviour
{
    [SerializeField] 
    ...
    {
        if (selectedCategory == GameData.TypeOfSport.Null)
        {
        ...
        else
        {
            ...
            if (createButton != null)
            {
                ...
                {
                    CreateMatchPanel.Instance.OpenCreateMatchPanel(selectedCategory);
                });
            }
        }
    }
